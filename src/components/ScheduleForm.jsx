    ...
    return ( 
      <form className="flex w-screen h-screen justify-center items-center gap-9 pl-24 pb-96">
        <div className="FormField flex-row h-1/2">
            ...
            <div className="h-20">
                <label htmlFor="mrn" className="block text-sm/6 font-medium text-gray-900">
                    MRN:
                </label>
                <div className="mt-2 w-96">
                    <input
            ...
            <div className="h-20 pt-1">
                <label htmlFor="diagnosis" className="block text-sm/6 font-medium text-gray-900">
                    Diagnosis:
                </label>
                <div className="mt-2 w-96 grid grid-cols-1">
                    <input
        ...
        <div className="FormField flex-row h-1/2">
            <div className="h-20">
                <label htmlFor="echoDate" className="block text-sm/6 font-medium text-gray-900">
                    Echo Date:
                </label>
                <div className="mt-2 w-96 grid grid-cols-1">
                    <input
            ...
            <div className="h-20">
                <label htmlFor="consultationAppointment" className="block text-sm/6 font-medium text-gray-900">
            ...
            <div className="h-20">
                <label htmlFor="physician" className="block text-sm/6 font-medium text-gray-900">
                    Physician:
                </label>
                <div className="mt-2 w-96 grid grid-cols-1">
                    <input
            ...
            <div className="pt-3 flex justify-start items-center">
                <label htmlFor="kccq" className="block text-sm/6 font-medium text-gray-900">
                    KCCQ Score:
                </label>
                <input
                    id="kccq"
            ...
            <div className="flex justify-start items-center">
                <label htmlFor="katz" className="block text-sm/6 font-medium text-gray-900">
                    KATZ Index Score:
                </label>
                <input
                    id="katz"
            ...
            <div className="flex justify-start items-center">
                <label htmlFor="sts" className="block text-sm/6 font-medium text-gray-900">
                    STS Score:
                </label>
                <input
                    id="katz"
            ...
            <div className="flex justify-between items-center h-12 w-56">
                <label htmlFor="pwt" className="block text-sm/6 font-medium text-gray-900 pr-3">
                    Patient Walk Test:
                </label>
                <select
                    id="pwt"
            ...
            <div className="flex pt-1">
                <div className="flex justify-between items-center h-12 w-56">
                    <label htmlFor="ctsConsultation" className="block text-sm/6 font-medium text-gray-900 pr-3">
                        CTS Consultation:
                    </label>
                    <select
                        id="ctsConsultation"
                ...
                <div className="appointmentTip justify-center items-center px-3 py-1 ml-2 bg-gray-200 rounded-lg text-center flex-row">
            ...
            <div className="flex pt-1">
                <div className="flex justify-between items-center h-12 w-56">
                    <label htmlFor="cardiacCath" className="block text-sm/6 font-medium text-gray-900 pr-3">
                        Cardiac Cath:
                    </label>
                    <select
                        id="cardiacCath"
            ...
            <div className="flex pt-1">
                <div className="flex justify-between items-center h-12 w-56">
                    <label htmlFor="ctTavrProtocol" className="block text-sm/6 font-medium text-gray-900 pr-3">
                        CT TAVR Protocol:
                    </label>
                    <select
                        id="ctTavrProtocol"
        ...
        <div className="FormField flex-row h-1/2">
            <div className="flex justify-between items-center h-12 w-72">
                <label htmlFor="continueTAVR" className="block text-sm/6 font-medium text-gray-900 pr-3">
            ...
            <div className="flex justify-between items-center h-12 w-72">
                <label htmlFor="ctScanUploaded" className="block text-sm/6 font-medium text-gray-900 pr-3">
                    CT Scan Uploaded:
                </label>
                <select
                    id="ctScanUploaded"
            ...
            <div className="flex justify-between items-center h-12 w-72">
                <label htmlFor="drReviewed" className="block text-sm/6 font-medium text-gray-900 pr-3">
            ...
            <div className="flex">
                <div className="flex justify-between items-center h-12 w-72">
                    <label htmlFor="otherTAVR" className="block text-sm/6 font-medium text-gray-900 pr-3">
            ...
            <div className="flex justify-between items-center h-12 w-72">
                <label htmlFor="completedTAVR" className="block text-sm/6 font-medium text-gray-900 pr-3">
            ...
            <div className="flex justify-between items-center h-12 w-72">
                <label htmlFor="powerPointCompleted" className="block text-sm/6 font-medium text-gray-900 pr-3">
            ...
            <div className="flex justify-between items-center h-12 w-72">
                <label htmlFor="discussSH" className="block text-sm/6 font-medium text-gray-900 pr-3">
            ...
            <div className="flex">
                <div className="pt-2 w-72 flex justify-end">
                    <button className="bg-orange-500 px-4 rounded-lg text-white">Update Patient</button>
                </div> 
                <div className="appointmentTip justify-center items-center px-3 py-1 ml-2 bg-gray-200 rounded-lg text-center flex-row">
            ...
            <div className="flex w-72 pt-4 justify-center items-center">
                <p className="text-xs text-red-600 font-semibold text-center">If all conditions met “Schedule TAVR” will turn blue.
                Once TAVR is scheduled the date will fill in</p>
            </div>
        </div>
      </form>
    );
