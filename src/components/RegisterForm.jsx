...
function RegisterForm() {
    return ( 
      <form className="flex w-screen h-screen justify-center items-center gap-9 pl-32">
        ...
        <div className="FormField flex-row h-1/2">
            ...
            <div className="h-20">
                ...
                <div className="">
                    <div className="flex items-center gap-3 h-8">
                        ...
                        <button className="bg-green-700 opacity-70 px-3 py-1 rounded-lg text-white text-sm">Upload Echo</button>
                        <button className="bg-gray-500 px-3 py-1 rounded-lg text-white text-sm">Obtain Echo</button>
                        <span className="infotext w-40 h-16 flex justify-center items-center p-2 bg-gray-200 rounded-lg text-center">Call XYZ office to request echo</span>
                    </div>
                    <div className="flex items-center pt-3">
                        <p className="text-red-500 text-xs font-semibold">If no echo date  &gt; 30, 'Schedule Echo' will highlight</p>
                        <div className="flex h-6 shrink-0 items-center pl-2">
                            ...
                            <div className="text-sm/6 pl-1">
                                <label htmlFor="echoAvailable" className="font-medium text-gray-400">
                                    No echo available
                                </label>
                            </div>
                        </div>
            ...
            <div className="pt-2 w-96 flex justify-end">
                <button className="bg-green-700 px-4 py-2 rounded-lg text-white">Register Patient</button>
            </div>
        </div>
      </form>
    );
